...
public class DSPlayground {
    ...
    private static void bsTree() {
        ...
        System.out.println("LCA (BST) of 3 and 10 :: " + tree.lca(tree.getRoot(), 3, 10).data);
        System.out.println("LCA (BT) of 3 and 10 :: " + tree.lcaBinaryTree(tree.getRoot(), 3, 10).data);
        System.out.println("Validate BST :: " + tree.validate());
    ...
    private static void graph() {
        ...
        List<String> topoOrder = GraphTraverse.topologicalSort(dag);
