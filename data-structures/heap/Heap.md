...
A heap is a complete binary tree stored as an array where each parent satisfies the heap property relative to its children. Use a heap when you need repeated access to the smallest or largest element — Top-K problems, scheduling by priority, or maintaining a running median.
